...
output_file = os.path.join(script_dir, "..", "reports", "junit", "resultados_junit_crear_cuadrantes_nodos.xml")
...
def ejecutar_prueba():
    ...
    try:
        ...
        result = subprocess.run(
            ["python", "-m", "pytest", "-s", "-q", "--maxfail=1",  "test/test_crear_cuadrantes_nodos.py"],
            #["pytest", "-s", "-q", "--maxfail=1", "test/test_crear_cuadrantes_nodos.py"],
